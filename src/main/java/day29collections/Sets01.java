...
public class Sets01 {
    public static void main(String[] args) {
        ...
        lhs.retainAll(ls);//lhs deki, ls ile ortak elemanlari aldi, olmayanlari sildi. lhs degisti ls ayni kaldi
        System.out.println(lhs);//[7, 13]ortaklari verdi ama kullandigimiz seti bozdu. oteki ayni kaldi
        ...
        System.out.println(ts.ceiling('T'));//T varsa kendini verir
        System.out.println(ts.ceiling('O'));//T yoksa, olsaydi nerde olur idiyse ondan sonrakini verir

        System.out.println(ts.floor('B'));//B ==> yer-zemin demek
