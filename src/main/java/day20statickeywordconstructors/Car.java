...
public class Car {
        ...
        /*
        Constructor nedir?
        Class dan object uretmemize yarayan code blocklaridir.(javanin object olusturmak kurdugu ozel kod blogudur)
        ...
        Gozle gorulmeyen otomatik olarak java tarafindan verilen bu constructorlara "default constructor" denir
         "default constructor" "    Car (){ }" seklindedir >>arka plandadir biz gormeyiz
         ...
         Interview sorusu>>>int lerde genelde iki kavram farki sorulur
