package day26polymorphism;//cok sekillli demek

public class Animal {
    //OOP concept in 2. prensibi
    /*
    1) Parent Class daki methodu child class icinde ozelleştirerek kullanmaya overriding yapmak denir
    2) Overriding te method signature a dokunulmaz (method signature= method ismi ve parantez)
   ...
   // final double pi=3.14; //deger atamadan olmaz
