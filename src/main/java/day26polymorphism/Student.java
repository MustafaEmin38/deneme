...
public class Student {
     ...
     */
    private String stdId="AC1232154";

    public String stdName="AliCan";
    public int age=13;
     ...
     */
    public void setStdId(String stdId) {//set nethoların return type lari her zaman void olur. cunku bisey dondurmeyecek. degistirecek
        this.stdId = stdId;
    }
