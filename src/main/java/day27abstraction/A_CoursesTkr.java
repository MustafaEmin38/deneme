...
public abstract class A_CoursesTkr {
    ...
    public void art(){
     ...
     /*
        ...
        Bizde yazmayiz
        3)Body si yazilmayan methoda Abstract Mehod denir. Abstract ingilizcede vucutsuz yada soyut demektir
        ...
        7) Body si olan methodlar (=Concrete Method) abstract classlarin icine yazilabilir (art() method gibi)
         ama Abstract methodlar concrete classlarin icine yazilamazlar. Concrete methodlar child classlar tarafindan
         override edilmek zorunda degildir istege bagli (extends i var> isterse override edebilir)
        ...
        override edilmek icin olusturulurlar.(child lar icin zorunludur ve override edilmek zorundadir)
        Bu celiskidir, bu yuzden java abstract methodlarin final olmasina musaade etmez  Ornek==>
        ...
        12) Bir class "abstract" class ise; abstract childi veya concrete childi olabiliyor. Eger child abstract ise
        ...
        olmalidir, cunku child classlar abstract olan parent classdaki abstract methodlari kullanirlar
