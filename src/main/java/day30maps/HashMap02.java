...
public class HashMap02 {
    public static void main(String[] args) {
        ...
        stdAges.put("Abdullah",24);//{Suleyman=33, Hasan=30, Abdullah=24, Gulce=30, Benna=33}
        ...
        //putIfAbsent("Ali",18); methodu map de "Ali" key olarak yoksa Ali key ini 18 value ile ekle demektir
        ...
        System.out.println(stdAges);//{Suleyman=33, Hasan=35, Gulce=35, Benna=33, Ali=18} silmedi cunku Ali 19 degil
