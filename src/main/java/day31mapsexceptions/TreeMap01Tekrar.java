...
public class TreeMap01Tekrar {
    public static void main(String[] args) {
        ...
        TreeMap<String,Integer> countryPopulation = new TreeMap<>(countryPop);
        System.out.println(countryPopulation);
        long t3=System.nanoTime();
        System.out.println(t2-t1);//979400
        System.out.println(t3-t2);//93500

        //Eger entry leri alfabetik olarak girmek istiyorsak bunu TreeMap le yapmayacagiz.Bu konuda HashMap ten faydalanacagiz
        //1. HashMap olusturup enrty leri HashMap hiziyla ekleyecegiz.
        //2. Sonra TreeMap olusturup, HashMap le olusturdugumuz enrtyrSet i TreeSet e cevirecegiz
