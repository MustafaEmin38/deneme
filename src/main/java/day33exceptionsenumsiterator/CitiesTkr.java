...
public enum CitiesTkr {
    /* Enum:
    *Degisme ihtimali olmayan datalari depolamak icin kullanilan ozel bir classtir
    DateTime obj (gun,ay vs), il isimleri,plaka/telefon kodlari esc
    *App de degismez datalara ihtiyac duyarsak bunlari uyg da depolamak gerekir. Neden? App i baska uyg lara bagimli
    yaparsak ve herhangi bir ariza durumunda kaynaga ulasamazsak (mesela google a) uygulamamiz coker. İste app miz ayakta
    kalabilsin diye enum lara depolariz. Buna "standalone" (bagimsiz) denir.
    * Enum a koydugumuz her bir data default olarak "publis static final"dir.
    * Or; ADANA bu bir enum sabitidir, string degildir,enum class sindan bir obj gibidir.
    * Java da degismez datalar buyuk yazilir, bu naming convention dir.
    ...
    CitiesTkr(int plateCode, String  cityName, String postalCode) {
    ...
    //Enum daki her data sabittir dolaysiyla enumdan yeni bir obj olusturulmaz
