...
public interface Ac  {
    ...
    void run();
    int price=2000;// variablenin basinda "public static final" var. ama bunlar inteface de default old icin yazmadik bile
        ...
        7) a) interface lerdeki tum variablelar otomatik olarak(default) olarak finaldir.Bu yuzden interfce icindeki
             variablei olusturdugunuzda mutlaka deger atamasi yapmalisiniz. Bilindigi gibi final variable larin degerleri degistirilemez
        ...
        8)  a) Normalde "interface" icine "concrete method" konulamaz ama bazi "ozel" durumlarda "concrete method"
        koymamiz gerekirse "default" keyword kullanarak bunu yapabiliriz
        NOTE : burda "default" access modifier degildir, concrete method koymak icin kullandigimiz bir keyworddur
            b) "static" keywordunu kullanarak da interface icine concrete method koyabiliriz
        ...
        11)
                ...
                interface       class        ==>    OLAMAZ(interfaceler parent olsn diye ozel olusturulmus bir yapi>>teyze)

                Ayni ise "extends" farkli ise implements kullaniriz, ve interface concrete, classin childi olamaz

                Abstract class ile interface arasindaki farklar nelerdir?==> interview soru
