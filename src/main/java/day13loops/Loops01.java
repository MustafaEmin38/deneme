...
public class Loops01 {
    public static void main(String[] args) {
        ...
        //Baslangic degeri  ;  Loop calisma sarti   ;   Artirma/eksiltme
           for(int i=1      ;          i<6          ;       i++           ) {
            System.out.println("Hi..!");
        }//int i=1 ==> i bir iken calısmaya basla
        //burda hep i yazilir. bir teamuldur. zorunlu degil mecburi:))
        ...
        for(int i=40  ;  i>22  ;  i-=2){//ben yazdim ama dinamik olmadı, 39 dan baslasa tek sayi basar
            System.out.println(i);
        }
        for(int i=40  ;  i>22  ;  i--){//best practise tir. her sartta calisir
            if(i%2==0){
            System.out.print(i+" ");
        }}
